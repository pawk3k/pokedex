...
var TreeView = React.forwardRef(function TreeView(props, ref) {
  ...
  var toggleExpansion = function toggleExpansion(event) {
    ...
    if (expanded.indexOf(value) !== -1) {
      ...
      newExpanded = [value].concat((0, _toConsumableArray2.default)(expanded));
    }
  ...
  var expandAllSiblings = function expandAllSiblings(event, id) {
    ...
    var newExpanded = [].concat((0, _toConsumableArray2.default)(expanded), (0, _toConsumableArray2.default)(diff));
    setExpandedState(newExpanded);
  ...
  var handleMultipleSelect = function handleMultipleSelect(event, value) {
    ...
    if (selected.indexOf(value) !== -1) {
      ...
      newSelected = [value].concat((0, _toConsumableArray2.default)(selected));
    }
  ...
  var getNodesToRemove = React.useCallback(function (id) {
    ...
    if (map) {
      ...
      if (map.children) {
        nodes.push.apply(nodes, (0, _toConsumableArray2.default)(map.children));
        map.children.forEach(function (node) {
          nodes.push.apply(nodes, (0, _toConsumableArray2.default)(getNodesToRemove(node)));
        });
      }
    }
